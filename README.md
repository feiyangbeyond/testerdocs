...
- 个人博客 [https://blog.tsxygfy.cn](https://blog.tsxygfy.cn)

## 前言

> 在互联网测试行业工作多年以后，我还是发现网上有关测试的学习资料还是太分散了，不像开发的学习资料那么系统化。某个圣诞节的午后，在咖啡屋里看到一位大学生正在读一本*《软件测试的艺术》*。我喝着一杯苦咖啡，又让我回想起自己当初学习测试的心酸经历。所以我决定开始写 **测试开发相关笔记** ，希望能帮到刚刚入行的测试新手们，希望能够给大家带来帮助！
